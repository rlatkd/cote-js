...
- 예정: `judge.md`, `problem.md`, `plagiarism.md` (서비스 네이밍은 [ADR-0003](../decisions/0003-monorepo-structure.md), tester는 problem 내부 모듈로 병합 — [ADR-0006](../decisions/0006-service-seams-and-ai-consolidation.md)).
